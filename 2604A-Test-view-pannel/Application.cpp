...
void Application::renderMenu() {
    ...
    if (ImGui::BeginMenu("View")) {
        if (ImGui::MenuItem("FrontView")) {
            _rotation = glm::vec2(0.0f, 0.0f);
        }
        if (ImGui::MenuItem("BackView")) {
            _rotation = glm::vec2(0.0f, 180.0f);
        }
        if (ImGui::MenuItem("LeftView")) {
            _rotation = glm::vec2(0.0f, -90.0f);
        }
        if (ImGui::MenuItem("RightView")) {
            _rotation = glm::vec2(0.0f, 90.0f);
        }
        if (ImGui::MenuItem("TopView")) {
            _rotation = glm::vec2(90.0f, 0.0f);
        }
        ImGui::EndMenu();
    }
...
void Application::renderLeftViewPanel() {
    ImGui::SetNextWindowPos(ImVec2(5.0f, 10.0f), ImGuiCond_FirstUseEver);
    ImGui::SetNextWindowSize(ImVec2(255.0f, 320.0f), ImGuiCond_FirstUseEver);
    if (!ImGui::Begin(" ")) {
        ImGui::End();
        return;
    }
